  ...
  return (
    <div className="card">
      <button
        ...
        className="w-full flex items-center justify-between text-left hover:bg-neo-sunken/30 -m-4 p-4 rounded-xl transition-colors"
      >
        <div className="flex items-center gap-2">
          <svg
            className={`w-4 h-4 text-neo-muted transition-transform ${expanded ? 'rotate-90' : ''}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      {expanded && (
        <div className="mt-4 space-y-4">
          ...
          <div>
            ...
            {/* Assets */}
            <div className="bg-neo-sunken/30 rounded-lg p-3 mb-3">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-semibold text-neo-muted">Assets</span>
                  <InfoTooltip
                    content={
                      <div>
                        <p className="font-semibold mb-1">Property Value</p>
                        <ul className="list-disc list-inside space-y-0.5 text-neo-muted">
            ...
            <div className="bg-neo-sunken/30 rounded-lg p-3 mb-3">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-semibold text-neo-muted">Liabilities</span>
                  <InfoTooltip
                    content={
                      <div>
            ...
            {/* Net Worth */}
            <div className="bg-emerald-50 border border-emerald-200/80 rounded-2xl p-3 mb-4 shadow-neo-inset-sm">
                  ...
                  <InfoTooltip
                    content={
                      <div>
                        ...
                        <p className="text-neo-muted">This is your equity in all properties combined.</p>
                      </div>
                    }
                  />
                </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-1.5 mb-2">
                <span className="text-xs font-semibold text-neo-muted">Annual Cash Flow Components</span>
                <InfoTooltip
                  content={
                    <div>
                      <p className="font-semibold mb-1">Cash Flow Calculation</p>
                      <p className="text-neo-muted mb-2">Shows the actual money flowing in and out each year.</p>
                      <p className="text-xs text-neo-muted">Formula: Income - Expenses - Investment Costs</p>
                    </div>
                  }
                />
              </div>

              <div className="bg-neo-sunken/30 rounded-lg p-3 space-y-2">
                {/* Income */}
                ...
                <div className="flex justify-between items-center text-xs">
                  <div className="flex items-center gap-1.5">
                    <span className="text-neo-muted">Operating Expenses</span>
                    <InfoTooltip
                      size="sm"
                      content={
                        <div>
                ...
                {baselineData.plannedInvestCost > 0 && (
                  <div className="flex justify-between items-center text-xs">
                    <div className="flex items-center gap-1.5">
                      <span className="text-neo-muted">Planned Investments</span>
                      <InfoTooltip
                        size="sm"
                        content={
                          <div>
                            <p className="text-neo-muted">One-off cash outflows for renovations, improvements, or other planned investments in your properties this year.</p>
                          </div>
                        }
                      />
                    </div>
                ...
                <div className="border-t border-neo-border pt-2 flex justify-between items-center">
                  <span className="text-xs font-semibold text-neo-muted">Net Cash Flow</span>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1.5">
                    <span className="text-xs font-semibold text-neo-muted">Cumulative Cash Flow</span>
                    <InfoTooltip
                      size="sm"
                      content={
                        <div>
                          <p className="text-neo-muted">The total sum of all annual cash flows from year 0 to year {baselineData.year}.</p>
                        </div>
                      }
                    />
                  </div>
            ...
            {/* Total Return */}
            <div className="bg-sky-50 border border-sky-200/80 rounded-2xl p-3 mt-3 shadow-neo-inset-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  <span className="text-xs font-semibold text-brand-700">Total Return</span>
                  <InfoTooltip
                    content={
                      <div>
                        <p className="font-semibold mb-1">Net Worth + Cumulative Cash Flow</p>
                        <p className="text-neo-muted">This represents your total wealth creation: equity gained plus all cash generated over time.</p>
                      </div>
                    }
                  />
                </div>
          ...
          {isComparison && (
            <div className="border-t border-neo-border pt-4">
              ...
              <div className="bg-neo-sunken/30 rounded-lg p-3 space-y-2">
                ...
                <div className="flex justify-between items-center text-xs">
                  <div className="flex items-center gap-1.5">
                    <span className="text-neo-muted">Property Value (kept)</span>
                    <InfoTooltip
                      size="sm"
                      content={
                        <div>
                          <p className="text-neo-muted">Value of properties you decided to keep (not sell).</p>
                        </div>
                      }
                    />
                  </div>
                ...
                {customData.investmentValue > 0 && (
                  <div className="flex justify-between items-center text-xs">
                    <div className="flex items-center gap-1.5">
                      <span className="text-neo-muted">Investment Value (sold)</span>
                      <InfoTooltip
                        size="sm"
                        content={
                          <div>
                            <p className="text-neo-muted mb-2">Proceeds from sold properties, compounded at your chosen investment rate (ETF, bonds, savings, etc.).</p>
                            <p className="text-xs text-neo-muted">Includes ETF/dividend taxes if applicable.</p>
                          </div>
                        }
                      />
                    </div>
                ...
                <div className="flex justify-between items-center text-xs">
                  <div className="flex items-center gap-1.5">
                    <span className="text-neo-muted">Loan Balance</span>
                  </div>
                  <span className="text-red-400 font-medium">
                ...
                <div className="border-t border-neo-border pt-2 flex justify-between items-center">
                  <span className="text-xs font-semibold text-neo-muted">Net Worth</span>
                ...
                {customData.investmentTax > 0 && (
                  <div className="flex justify-between items-center text-xs">
                    <div className="flex items-center gap-1.5">
                      <span className="text-neo-muted">Investment Tax Paid</span>
                      <InfoTooltip
                        size="sm"
                        content={
                          <div>
                            <p className="text-neo-muted">Belgian tax on ETF/dividend income (TOB + dividend withholding if configured).</p>
                          </div>
                        }
                      />
                    </div>
              ...
              {/* Comparison Delta */}
              <div className="bg-neo-sunken/60 border border-neo-border rounded-lg p-3 mt-3">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-semibold text-neo-muted">Net Worth Difference</span>
